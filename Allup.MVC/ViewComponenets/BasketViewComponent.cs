...
namespace Allup.MVC.ViewComponenets
{
    public class BasketViewComponent :  ViewComponent
    {
        ...
        public BasketViewComponent(IProductService productService, ILanguageService languageService,IBasketUiService basketUiService)
        {
        ...
        {
            var get= await _basketUiService.GetBasketUiViewModelAsync();
            return View(get);
